...
class DificilPage extends StatefulWidget {
  const DificilPage({super.key});

  @override
  State<DificilPage> createState() => _DificilPageState();
}

class _DificilPageState extends State<DificilPage> {
  String _estado = "";
  String _numero = "";
  ...
  void _compararNumeros() {
    ...
    final n5 = _numero.length > 4 ? _numero[4] : '';
